...
REGIONS = {
    ...
    "mazowieckie": {
        ...
        "source": "mazowieckie_batch",
        "cities": [
            ("Warszawa", ["Srodmiescie", "Mokotow", "Wola", "Praga Polnoc", "Praga Poludnie", "Ursynow", "Zoliborz", "Bemowo", "Bielany", "Targowek"]),
            ("Radom",           None),
            ("Plock",           None),
            ("Siedlce",         None),
            ("Ostroleka",       None),
    ...
    "malopolskie": {
        ...
        "source": "malopolskie_batch",
        "cities": [
            ("Krakow", ["Krowodrza", "Podgorze", "Nowa Huta", "Bronowice", "Pradnik Czerwony", "Biezanow-Prokocim", "Debniki", "Zwierzyniec"]),
            ("Tarnow",    None),
            ("Nowy Sacz", None),
            ("Oswiecim",  None),
            ("Chrzanow",  None),
    ...
    "slaskie": {
        ...
        "cities": [
            ...
            ("Bielsko-Biala",    None),
            ("Czestochowa",      None),
            ("Dabrowa Gornicza", None),
            ("Chorzow",          None),
            ("Jaworzno",         None),
            ("Siemianowice Slaskie", None),
            ("Myslowice",        None),
        ],
    },
    "pomorskie": {
        "label": "Pomorskie (Trójmiasto)",
        "source": "pomorskie_batch",
        "cities": [
            ("Gdansk",  ["Srodmiescie", "Oliwa", "Wrzeszcz", "Morena", "Przymorze", "Nowy Port"]),
            ("Gdynia",          None),
            ("Sopot",           None),
            ("Slupsk",          None),
            ("Starogard Gdanski",None),
            ("Tczew",           None),
            ("Wejherowo",       None),
            ("Pruszcz Gdanski", None),
            ("Koscierzyna",     None),
            ("Chojnice",        None),
            ("Malbork",         None),
        ],
    ...
    "kujawsko_pomorskie": {
        ...
        "source": "kujawsko_pomorskie_batch",
        "cities": [
    ...
    "warminsko_mazurskie": {
        ...
        "source": "warminsko_mazurskie_batch",
        "cities": [
            ...
            ("Bartoszyce",None),
            ("Ilawa",     None),
            ("Lidzbark Warminski", None),
        ],
    },
    "podlaskie": {
        "label": "Podlaskie (Białystok)",
        "source": "podlaskie_batch",
        "cities": [
            ...
            ("Zambrow",   None),
            ("Hajnowka",  None),
            ("Bielsk Podlaski", None),
            ("Wysokie Mazowieckie", None),
        ],
    },
    "lubelskie": {
        "label": "Lubelskie (Lublin)",
        "source": "lubelskie_batch",
        "cities": [
            ...
            ("Biala Podlaska", None),
            ("Lubartow",  None),
            ("Miedzyrzec Podlaski", None),
        ],
    },
    "podkarpackie": {
        "label": "Podkarpackie (Rzeszów)",
        "source": "podkarpackie_batch",
        "cities": [
    ...
    "swietokrzyskie": {
        ...
        "source": "swietokrzyskie_batch",
        "cities": [
            ("Kielce", ["Srodmiescie", "Bocianek", "Barwinek", "Ksm", "Czarnow"]),
            ("Skarzysko-Kamienna",  None),
            ("Starachowice",        None),
            ("Ostrowiec Swietokrzyski", None),
            ("Busko-Zdroj",         None),
            ("Jedrzejow",           None),
            ("Konskie",             None),
            ("Wloszczowa",          None),
    ...
    "opolskie": {
        ...
        "source": "opolskie_batch",
        "cities": [
            ("Opole", ["Srodmiescie", "Nowa Wies Krolewska", "Goslawice", "Zaodrze", "Malinka"]),
            ("Kedzierzyn-Kozle",    None),
            ("Nysa",                None),
            ("Brzeg",               None),
            ("Kluczbork",           None),
            ("Strzelce Opolskie",   None),
            ("Prudnik",             None),
            ("Namyslow",            None),
        ],
    },
    "zachodniopomorskie": {
        ...
        "source": "zachodniopomorskie_batch",
        "cities": [
